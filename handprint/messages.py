...
# Although the Python colorful package docs state that it ships with rgb.txt
# colors, when I tried to use those names it didn't work for me.  I resorted
# to defining them directly here.  These are all the unique names from the
# file /usr/share/emacs/22.1/etc/rgb.txt, with the modification that they are
# all in lower (because otherwise colorful doesn't recognize them).
